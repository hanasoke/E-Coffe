    ...
    <nav class="navbar navbar-expand-lg navbar-light">
        ...
        <div class="collapse navbar-collapse" id="navbarNav">
            <ul class="navbar-nav ml-auto">
                ...
                <li class="nav-item">
                    <a class="nav-link" href="#services">COFFEE MENU</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link" href="#about-us">ADVANTAGE</a>
                </li>
                <li class="nav-item">
    ...
    <div class="container">
        <div class="row">
            <div class="col-md-6">
                ...
                <a href="register.jsp"><img src="img/cart.png" class="play-btn"></a>Let's Buy a coffee (click the basket)
            </div>
...
<section id="about-us">
    <div class="container">
        <h1 class="title text-center">ADVANTAGE E-COFFEE</h1>
        <div class="row">
            <div class="col-md-6">
                <p class="about-title">Why we're Different ?</p>
                <ul>
                    <li>Understand the right coffee concoction</li>
                    <li>We have good packaging</li>
                    <li>We deliver to the costumer just for 10 minutes</li>
                    <li>We have a good experienced barista</li>
                    <li>We protect costumer rights</li>
                    <li>Very affordable prices suitable for student pockets</li>
                    <li>We present the best quality coffee</li>
...
<section id="testimonials">
    <div class="container">
        ...
        <div class="row offset-1">
            ...
            <div class="col-md-4 testimonials">
                <p style="margin-bottom: 20px;">Good communication is just as stimulating as black coffee, and just as hard to sleep after.</p>
                <img style="margin-top: 10px; margin-bottom: 10px;" src="img/user3.png">
                <p class="userdetails">
                    <b>Syarif Husein</b>
                    <br>
                    Newbie
